...
const ResumeCard = ({title,subTitle,result,des}) => {
  return (
    <div className='w-full h-auto xs:h-[1000px] md:h-1/3 group flex'>
 ...
 <div >
  <h3 className='text-sm sm:text-xl md:text-2xl font-semibold group-hover:text-white duration-300'>{title}</h3>
